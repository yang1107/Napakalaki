...
//
//     Monster m1;
// BadConsequence badConsequence = new BadConsequence("Estos monstruos resultan bastante superficiales y te aburren mortalmente. Estas muerto",true);
//        Prize prize = new Prize(2,1);
//        
//   m1=new Monster("Angeles de la noche ibicenca",14,badConsequence,prize);
////       
